...
export async function POST(req: NextRequest) {
  try {
    ...
    // Verify all game instances exist and are at centers this user supervises
    ...
    if (gameInstances.length !== gameInstanceIds.length) {
      return apiResponse(false, null, { message: 'One or more game instances not found at your supervised centers' }, 404);
    }
