...
import { Users, Building, Gamepad2, TrendingUp, Clock, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-orange-600">{stats.pendingRentals}</div>
